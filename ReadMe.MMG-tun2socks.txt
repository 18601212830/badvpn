...
route add <IP_of_SSH_server> <IP_of_original_gateway> metric 5 <same for DNS> route add 0.0.0.0 mask 0.0.0.0 10.0.0.2 metric 6
...
If you have questions about tun2socks, you may be able to find me in #badvpn on Freenode IRC. Alternatively, you can send me an email to . If you have found a bug or want to propose a new feature, you can open an issue on the tracker.
